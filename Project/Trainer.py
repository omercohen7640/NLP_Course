...
class NNTrainer:
    def __init__(self, model, epochs, dataset, test_set, seed, LR, LRD, WD, MOMENTUM, GAMMA,
        ...
        #TODO: fix loss function and optimizer
    ...
    def train(self):
        ...
        for epoch in range(0, self.epochs):
            self._train(epoch, train_gen)
            last_uas = self._test(epoch, test_gen)
        self.update_best_acc(epoch, last_uas)
        return last_uas

    def _train(self, epoch, train_gen):
        ...
        for i, (images, target) in enumerate(train_gen):
            ...
            # TODO: loss measurment needs to be fixed
            raise NotImplementedError
    ...
    def _test(self, epoch, test_gen, gpu=0, save=True):
